...
export default function CardOpcoesDeOspedagem({ title, subTitle, price, image }: CardOpcoesDeOspedagemProps) {
    return (
        <section className="shadow-3xl grid grid-cols-4 items-center bg-white rounded-2xl mb-16">
            <div className="col-span-1 bg-blue lg:col-span-4">
                <div className="">
                    <Image src={image} width='100%' height='50%' layout="responsive" />
                </div>
            </div>
            <div className="col-span-2 lg:col-span-4  pl-14 lg:pl-2 pr-5 lg:pr-0 py-10 text-text ">
                <div className="leading-[8px] lg:px-10 ">
                ...
                {/* ============ specifications ============ */}
                <div className="grid grid-cols-2 lg:col-span-4 lg:px-10">
