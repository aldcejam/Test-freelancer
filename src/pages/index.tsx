    ...
    <div className='bg-gray'>
      <div className='relative h-[90vh]'>
        ...
        <div className='absolute text-white mt-[35vh] left-0 right-0 max-w-[1250px] mx-auto xl:mx-10 px-10 '>
          ...
          <h3 className='text-[52px]'>Natureza</h3>
        </div>
      </div>
      {/* ========================================= */}
      ...
      <section className='shadow-3xl bg-white max-w-[1250px] mx-auto xl:mx-10 pt-10 pb-1  px-10 mt-14 rounded-2xl'>
        ...
        <CardRoteiroDoPacote
          withImage={true}
          withVideo={true}
          image='/illustration/GrupoDeMascara.png'
        ...
        <CardRoteiroDoPacote
          withImage={true}
          withVideo={false}
          image='/illustration/imgDia2.png'
        ...
        <CardRoteiroDoPacote
          withImage={false}
          withVideo={true}
          image='/illustration/imgDia3.png'
        ...
        <CardRoteiroDoPacote
          withImage={false}
          withVideo={false}
          image='/illustration/imgDia4.png'
